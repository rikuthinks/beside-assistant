...
function generatePrompt(question: Props) {
  ...
  A: Water is composed of two hydrogen atoms bonded to one oxygen atom, resulting in the chemical formula H2O. The answer is H2O.
  ...
  A: Jane Austen wrote the novel "Pride and Prejudice," which was published in 1813 and is widely regarded as one of the greatest works of English literature.
  ...
  A: Ottawa is the largest city in Canada and serves as the country's political and cultural center. Ottawa is the capital of Canada.
